        ...
        <div className={styles.cards}>
          ...
          <div className={styles.drawings}>
            <div className={styles.drawingsContainer}>
              ...
              <h3>- Стройтельний кейс</h3>
              <h3>- Строительный методлар</h3>
              <h3>- Стройтельний бланкалар</h3>
              <h3>- Стройтельний журналах</h3>
              <h3>- Стройтельний Акт</h3>
              <h3>- Стройтельний программа</h3>
              <h3>- Производство</h3>
              <h3>- Дело производства</h3>
              <h3>- Стройтельний бизнес</h3>
              <h3>- Бизнес кейс</h3>
              <h3>- бизнес методика</h3>
              <h3>- Таълим кейс</h3>
              <h3>- Таълим методика</h3>
            </div>
          </div>
