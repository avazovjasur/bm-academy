...
const Intro = () => {
    return <section className={styles.intro}>
        <div className={styles.container}>
            <p className={styles.title}>Добро пожаловать на</p>
            ...
            <a href="#about" className={styles.anim}>
                <svg className={styles.rect} width="47" height="46" viewBox="0 0 47 46" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <rect x="-1.24873" y="23" width="35" height="35" rx="5.5" transform="rotate(-45 -1.24873 23)" stroke="url(#paint0_diamond_28_35)"/>
                    <defs>
            ...
            <a href="#about" className={styles.scrollText}>про скрольте чтобы увидеть больше</a>
        </div>
    </section>
}
