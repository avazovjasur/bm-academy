    ...
    <>
      <div className={`${styles.menu} ${showMenu ? styles.active : ''}`}>
        ...
        <div className={styles.dropDown}>
            <button onClick={() => setShowLang(!showLang)} type="button" className={`${styles.dropDownLabel} ${styles.dropDownLang}`}>
            ...
            <div className={`${styles.dropDownInner} ${showLang ? styles.active : ''}`}>
